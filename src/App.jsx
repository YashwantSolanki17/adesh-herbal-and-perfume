...
const products = [
  ...
  { id: 6, emoji: '🌹', name: 'Rose Ittar',        sub: '10ml · Pure & Long Lasting',  price: 499, badge: 'Popular' },
]
      ...
      <ul style={styles.navLinks}>
        ...
        <li>
          <button
            ...
            style={{
              ...styles.navLink,
              fontWeight: page === 'products' ? 700 : 400,
              color: page === 'products' ? '#3B6D11' : '#555',
            }}>
            Products
          </button>
        </li>
        <li>
          <button style={{ ...styles.navLink, color: '#555', fontWeight: 400 }}>
            About
          </button>
        </li>
        <li>
    ...
    <section style={styles.hero}>
      <div style={styles.heroContent}>
        ...
        <p style={styles.heroDesc}>
          Authentic herbal products — Arks, Oils, Soaps, Honey, Ittars,
          Perfumes and more. Trusted Ayurvedic wellness for your family.
        </p>
        <div style={styles.heroBtns}>
          <button style={styles.btnPrimary} onClick={() => setPage('products')}>
            Shop Now →
          </button>
...
// ─── Home Page ────────────────────────────────────────────────
function Home({ setPage, cart, setCart }) {
    ...
    <div>
      ...
      <section style={styles.section}>
        <div style={styles.sectionHeader}>
          ...
          <button style={styles.seeAll} onClick={() => setPage('products')}>
            View all →
          </button>
        </div>
...
const styles = {
  ...
  btnPrimary:    { background:'#3B6D11', color:'#EAF3DE', border:'none', borderRadius:8, padding:'12px 24px', fontSize:14, cursor:'pointer' },
  ...
  seeAll:        { fontSize:13, color:'#3B6D11', background:'none', border:'none', cursor:'pointer' },
  ...
  addBtn:        { width:28, height:28, borderRadius:'50%', background:'#3B6D11', color:'#fff', border:'none', fontSize:18, display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer' },
